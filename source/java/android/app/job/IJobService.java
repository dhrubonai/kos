...
public interface IJobService extends IInterface {
    ...
    public static class _Parcel {
        public static /* bridge */ /* synthetic */ Object a(Parcel parcel) {
            return readTypedObject(parcel, JobParameters.CREATOR);
        }
    ...
    public static abstract class Stub extends Binder implements IJobService {
        ...
        public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) {
            ...
            if (i == 1) {
                Parcelable.Creator creator = JobParameters.CREATOR;
                startJob((JobParameters) _Parcel.a(parcel));
            ...
            Parcelable.Creator creator2 = JobParameters.CREATOR;
            stopJob((JobParameters) _Parcel.a(parcel));
            parcel2.writeNoException();
            return true;
        }
