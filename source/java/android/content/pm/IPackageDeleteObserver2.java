...
public interface IPackageDeleteObserver2 extends IInterface {
    ...
    public static class _Parcel {
        public static /* bridge */ /* synthetic */ Object a(Parcel parcel) {
            return readTypedObject(parcel, Intent.CREATOR);
        }
    ...
    public static abstract class Stub extends Binder implements IPackageDeleteObserver2 {
        ...
        public static IPackageDeleteObserver2 asInterface(IBinder iBinder) {
            ...
            return (iInterfaceQueryLocalInterface == null || !(iInterfaceQueryLocalInterface instanceof IPackageDeleteObserver2)) ? new Proxy(iBinder) : (IPackageDeleteObserver2) iInterfaceQueryLocalInterface;
        }
        ...
        public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) {
            ...
            if (i == 1) {
                ...
                onUserActionRequired((Intent) _Parcel.a(parcel));
