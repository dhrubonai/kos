...
public class DialogTitle extends jg {
    ...
    public final void onMeasure(int i, int i2) throws IllegalAccessException, IllegalArgumentException, InvocationTargetException {
        ...
        setSingleLine(false);
        setMaxLines(2);
        TypedArray typedArrayObtainStyledAttributes = getContext().obtainStyledAttributes(null, gv1.r, R.attr.textAppearanceMedium, R.style.TextAppearance.Medium);
