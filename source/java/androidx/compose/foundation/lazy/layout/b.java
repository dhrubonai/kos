...
public final class b extends g01 implements wm0 {
    ...
    public final Object invoke(Object obj, Object obj2, Object obj3) {
        ...
        if (M == obj4) {
            M = new m31(v22Var, new z10(2, this.h));
            txVar.i0(M);
        }
        m31 m31Var = (m31) M;
        Object M2 = txVar.M();
        if (M2 == obj4) {
            M2 = new og2(new l6(m31Var));
            txVar.i0(M2);
        }
        og2 og2Var = (og2) M2;
        a41 a41Var = this.e;
        if (a41Var != null) {
            ...
            boolean f2 = txVar.f(a41Var) | txVar.h(m31Var) | txVar.h(og2Var) | txVar.h(obj6);
            Object M4 = txVar.M();
            if (f2 || M4 == obj4) {
        ...
        int i = b41.b;
        nd1 nd1Var = this.f;
        if (a41Var != null && (k = nd1Var.k(new TraversablePrefetchStateModifierElement(a41Var))) != null) {
            nd1Var = k;
        }
        boolean f3 = txVar.f(m31Var);
        Object obj8 = this.g;
        boolean f4 = f3 | txVar.f(obj8);
        Object M6 = txVar.M();
        if (f4 || M6 == obj4) {
            M6 = new x5(14, m31Var, obj8);
            txVar.i0(M6);
        }
        jm.i(og2Var, nd1Var, (Function2) M6, txVar, 8);
        return up2.f1186a;
    }
}
