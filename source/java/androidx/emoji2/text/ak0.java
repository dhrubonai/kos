...
public final class ak0 extends md1 implements jk0, ViewTreeObserver.OnGlobalFocusChangeListener {
    ...
    public final void onGlobalFocusChanged(View view, View view2) {
        ...
        View viewL = lx0.l(this);
        ek0 focusOwner = ((v7) lx0.U(this)).getFocusOwner();
        tl1 tl1VarU = lx0.U(this);
        boolean z = (view == null || view.equals(tl1VarU) || !lx0.j(viewL, view)) ? false : true;
        boolean z2 = (view2 == null || view2.equals(tl1VarU) || !lx0.j(viewL, view2)) ? false : true;
        if (z && z2) {
            this.r = view2;
            return;
        }
        ...
        this.r = view2;
        rk0 rk0VarI0 = I0();
        int iOrdinal = rk0VarI0.K0().ordinal();
