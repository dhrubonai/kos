...
public final class ao1 extends lq2 {
    ...
    public final void e() {
        ...
        if (lx0.n(this.h, waVar)) {
            ...
            Path.FillType fillType = this.h.f1269a.getFillType();
            Path.FillType fillType2 = Path.FillType.EVEN_ODD;
            boolean z = fillType == fillType2;
            this.h.f1269a.rewind();
            Path path = this.h.f1269a;
            if (!z) {
        ...
        ?? r0 = this.i;
        ((xa) r0.getValue()).f1325a.setPath(waVar != null ? waVar.f1269a : null, false);
        float length = ((xa) r0.getValue()).f1325a.getLength();
