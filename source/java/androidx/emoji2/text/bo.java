...
public final class bo {
    ...
    public final boolean equals(Object obj) {
        ...
        bo boVar = (bo) obj;
        return et.c(this.f160a, boVar.f160a) && et.c(this.b, boVar.b) && et.c(this.c, boVar.c) && et.c(this.d, boVar.d);
    }

    public final int hashCode() {
        int i = et.l;
        return Long.hashCode(this.d) + jx0.b(jx0.b(Long.hashCode(this.f160a) * 31, 31, this.b), 31, this.c);
    }
}
