...
public final class bu0 {
    ...
    public final boolean equals(Object obj) {
        ...
        bu0 bu0Var = (bu0) obj;
        return lx0.n(this.f167a, bu0Var.f167a) && this.b.equals(bu0Var.b) && lx0.n(this.c, bu0Var.c) && this.d == bu0Var.d && this.e == bu0Var.e && lx0.n(this.f, bu0Var.f) && lx0.n(this.g, bu0Var.g) && lx0.n(this.h, bu0Var.h) && this.i.equals(bu0Var.i) && this.j == bu0Var.j && this.k == bu0Var.k && this.l == bu0Var.l && this.m == bu0Var.m && this.n == bu0Var.n && this.o == bu0Var.o && this.p == bu0Var.p && lx0.n(this.q, bu0Var.q) && lx0.n(this.r, bu0Var.r) && lx0.n(this.s, bu0Var.s) && lx0.n(this.t, bu0Var.t) && lx0.n(this.u, bu0Var.u) && this.v.equals(bu0Var.v) && this.w == bu0Var.w && this.x.equals(bu0Var.x) && this.y.equals(bu0Var.y) && lx0.n(this.z, bu0Var.z);
    }

    public final int hashCode() {
        int hashCode = (this.b.hashCode() + (this.f167a.hashCode() * 31)) * 31;
        ki2 ki2Var = this.c;
        int hashCode2 = (this.f.hashCode() + ((this.e.hashCode() + ((this.d.hashCode() + ((hashCode + (ki2Var != null ? ki2Var.hashCode() : 0)) * 923521)) * 961)) * 29791)) * 31;
        this.g.getClass();
        return this.z.hashCode() + ((this.y.hashCode() + ((this.x.d.hashCode() + ((this.w.hashCode() + ((this.v.hashCode() + ((this.u.hashCode() + ((this.t.hashCode() + ((this.s.hashCode() + ((this.r.hashCode() + ((this.q.hashCode() + ((this.p.hashCode() + ((this.o.hashCode() + ((this.n.hashCode() + jx0.d(jx0.d(jx0.d(jx0.d((this.i.f1339a.hashCode() + ((((fi1.class.hashCode() + hashCode2) * 31) + Arrays.hashCode(this.h.d)) * 31)) * 31, 31, this.j), 31, this.k), 31, this.l), 31, this.m)) * 31)) * 31)) * 31)) * 31)) * 31)) * 31)) * 31)) * 31)) * 31)) * 31)) * (-1807454463))) * 31);
    }
}
