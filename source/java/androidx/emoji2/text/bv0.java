...
public final class bv0 {
    ...
    public bv0(TextInputLayout textInputLayout) {
    ...
    public final void a(jg jgVar, int i) {
        ...
        if (i == 0 || i == 1) {
            ...
            this.k.addView(jgVar);
        } else {
            this.i.addView(jgVar, new LinearLayout.LayoutParams(-2, -2));
        }
    ...
    public final void d(ArrayList arrayList, boolean z, jg jgVar, int i, int i2, int i3) {
        if (jgVar == null || !z) {
            return;
        }
        if (i == i3 || i == i2) {
    ...
    public final void g(jg jgVar, int i) {
        ...
        if ((i == 0 || i == 1) && (frameLayout = this.k) != null) {
            frameLayout.removeView(jgVar);
        } else {
            linearLayout.removeView(jgVar);
        }
        int i2 = this.j - 1;
        this.j = i2;
        LinearLayout linearLayout2 = this.i;
    ...
    public final boolean h(jg jgVar, CharSequence charSequence) {
        TextInputLayout textInputLayout = this.h;
        if (textInputLayout.isLaidOut() && textInputLayout.isEnabled()) {
            return (this.o == this.n && jgVar != null && TextUtils.equals(jgVar.getText(), charSequence)) ? false : true;
        }
        return false;
    }
