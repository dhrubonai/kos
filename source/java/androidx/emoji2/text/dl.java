...
public final class dl implements n5 {
    ...
    public final long a(long j, long j2, q01 q01Var) {
        ...
        float f = 1;
        float f2 = (this.f258a + f) * (((int) (j3 >> 32)) / 2.0f);
    ...
    public final boolean equals(Object obj) {
        ...
        return (obj instanceof dl) && Float.compare(this.f258a, ((dl) obj).f258a) == 0 && Float.compare(-1.0f, -1.0f) == 0;
    }

    public final int hashCode() {
        return Float.hashCode(-1.0f) + (Float.hashCode(this.f258a) * 31);
    }

    public final String toString() {
        return "BiasAbsoluteAlignment(horizontalBias=" + this.f258a + ", verticalBias=-1.0)";
    }
}
