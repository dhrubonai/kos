        ...
        try {
            ...
            try {
                if (b(zipFile, Build.CPU_ABI, file2)) {
                    zipFile.close();
                    a2 = a.a.a.c.a(-1370043586854690L, strArr);
                    ...
                    zipFile.close();
                    a2 = a.a.a.c.a(-1370129486200610L, strArr);
                    sb = new StringBuilder();
            ...
            Log.d(a.a.a.c.a(-1370249745284898L, strArr), a.a.a.c.a(-1370838155804450L, strArr) + (System.currentTimeMillis() - currentTimeMillis) + a.a.a.c.a(-1370872515542818L, strArr));
            throw th;
        }
    }
        ...
        while (entries.hasMoreElements()) {
            ...
            if (z || name.startsWith(a.a.a.c.a(-1371057199136546L, strArr))) {
                if (name.endsWith(a.a.a.c.a(-1370563277897506L, strArr)) && name.startsWith(str2)) {
                    ...
                    Log.d(a.a.a.c.a(-1370713601752866L, strArr), a.a.a.c.a(-1370752256458530L, strArr) + substring);
                    File file2 = new File(file, substring);
                    if (file2.exists() && file2.length() == nextElement.getSize()) {
                        String a2 = a.a.a.c.a(-1364786546884386L, strArr);
                        StringBuilder k = jx0.k(substring);
                        k.append(a.a.a.c.a(-1364825201590050L, strArr));
                        Log.d(a2, k.toString());
                    } else {
                        FileOutputStream fileOutputStream = new FileOutputStream(file2);
                        Log.d(a.a.a.c.a(-1364838086491938L, strArr), a.a.a.c.a(-1364876741197602L, strArr) + nextElement.getName() + a.a.a.c.a(-1364966935510818L, strArr) + str);
