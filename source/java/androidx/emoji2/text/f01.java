...
public final class f01 extends mt {
    public final /* synthetic */ int d;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public /* synthetic */ f01(int i, int i2, long j, String str) {
        super(i, str, j);
        this.d = i2;
    }
    ...
    public final float e(float f, float f2, float f3) {
        switch (this.d) {
            case 0:
                ...
                return (f4 > 0.20689656f ? f4 * f4 * f4 : 0.12841855f * (f4 - 0.13793103f)) * l8.i[2];
            default:
                if (f3 < -2.0f) {
                    f3 = -2.0f;
                }
    ...
    public final long f(float f, float f2, float f3, float f4, mt mtVar) {
        switch (this.d) {
            ...
            default:
                ...
                return bz0.b(f, f2, f3 <= 2.0f ? f3 : 2.0f, f4, mtVar);
        }
    }
}
