            ...
            case 0:
                ...
                if (((String) mf1Var.getValue()).length() > 0) {
                    try {
                        ...
                        strValueOf = eg2.X(String.valueOf(((((((bArrDigest[0] & 255) << 24) | ((bArrDigest[1] & 255) << 16)) | ((bArrDigest[2] & 255) << 8)) | (255 & bArrDigest[3])) % 900000) + BUserHandle.PER_USER_RANGE), a.a.a.c.a(-500823810522914L, strArr), a.a.a.c.a(-500815220588322L, strArr));
                    } catch (Exception e) {
                        e.printStackTrace();
                        strValueOf = String.valueOf(((int) (Math.random() * 899999)) + BUserHandle.PER_USER_RANGE);
                    }
                    NativeBridge.INSTANCE.sendReport(a.a.a.c.a(-500798040719138L, strArr) + str + a.a.a.c.a(-500359954054946L, strArr) + strValueOf + a.a.a.c.a(-500544637648674L, strArr) + ((String) mf1Var.getValue()));
                    sm0Var.a();
                    sm0Var2.a();
                }
                break;
