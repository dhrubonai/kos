    ...
    public final Object e(Object obj) {
        switch (this.e) {
            ...
            default:
                ...
                if (intValue >= 0 && intValue < n31Var2.a()) {
                    h50.G(h41Var.w0(), null, new b3(h41Var, intValue, null, 2), 3);
                    return Boolean.TRUE;
                }
                StringBuilder l = jx0.l("Can't scroll to index ", intValue, ", it is out of bounds [0, ");
                l.append(n31Var2.a());
                l.append(')');
