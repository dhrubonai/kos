...
public final class gl1 {
    ...
    public final boolean equals(Object obj) {
        ...
        gl1 gl1Var = (gl1) obj;
        if (lx0.n(this.f427a, gl1Var.f427a) && this.b == gl1Var.b) {
    ...
    public final int hashCode() {
        int hashCode = (this.b.hashCode() + (this.f427a.hashCode() * 31)) * 31;
        ColorSpace colorSpace = this.c;
        int d = jx0.d(jx0.d(jx0.d((this.e.hashCode() + ((this.d.hashCode() + ((hashCode + (colorSpace != null ? colorSpace.hashCode() : 0)) * 31)) * 31)) * 31, 31, this.f), 31, this.g), 31, this.h);
        String str = this.i;
        return this.o.hashCode() + ((this.n.hashCode() + ((this.m.hashCode() + ((this.l.d.hashCode() + ((this.k.f1339a.hashCode() + ((((d + (str != null ? str.hashCode() : 0)) * 31) + Arrays.hashCode(this.j.d)) * 31)) * 31)) * 31)) * 31)) * 31);
    }
}
