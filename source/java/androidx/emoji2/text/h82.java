...
public final class h82 {
    ...
    static {
        ...
        lx0.w(playGamesGamePackages, a.a.a.c.a(-332435322715938L, wj1.f1283a));
    ...
    public static boolean e(String str) {
        lx0.x(str, a.a.a.c.a(-330292134035234L, wj1.f1283a));
        return b.contains(str);
    }

    public static String f(int i, String str) {
        return a.a.a.c.a(-330120335343394L, wj1.f1283a) + i + '_' + str;
    }
    ...
    public final void a(int i, String str) {
        ...
        if (e(str)) {
            this.f459a.edit().putString(f(i, str), fs1Var.name()).apply();
        }
    }

    public final int b() {
        return this.f459a.getInt(a.a.a.c.a(-331486134943522L, wj1.f1283a), 0);
    }
    ...
    public final bh0 c(int i) {
        ...
        String[] strArr = wj1.f1283a;
        String j = jx0.j(sb, a.a.a.c.a(-331237026840354L, strArr), i);
        SharedPreferences sharedPreferences = this.f459a;
        String string = sharedPreferences.contains(j) ? sharedPreferences.getString(j, bh0.g.d) : sharedPreferences.getString(a.a.a.c.a(-331318631218978L, strArr), bh0.g.d);
        bh0.f.getClass();
    ...
    public final mp0 d(int i) {
        StringBuilder sb = new StringBuilder();
        String[] strArr = wj1.f1283a;
        String string = this.f459a.getString(jx0.j(sb, a.a.a.c.a(-331632163831586L, strArr), i), a.a.a.c.a(-331718063177506L, strArr));
        if (string == null) {
            try {
    ...
    public final void g(int i, bh0 bh0Var) {
        ...
        this.f459a.edit().putString(jx0.j(new StringBuilder(), a.a.a.c.a(-331421710434082L, strArr), i), bh0Var.d).apply();
    }

    public final void h(int i, mp0 mp0Var) {
        String[] strArr = wj1.f1283a;
        lx0.x(mp0Var, a.a.a.c.a(-331756717883170L, strArr));
        this.f459a.edit().putString(jx0.j(new StringBuilder(), a.a.a.c.a(-330137515212578L, strArr), i), mp0Var.name()).apply();
    }
