...
public final class hg2 extends z60 implements w01, ss1, wj0 {
    ...
    public final gb1 d(hb1 hb1Var, ab1 ab1Var, long j) {
        int iI0 = hb1Var.i0(androidx.compose.foundation.text.handwriting.a.f36a);
        int iI02 = hb1Var.i0(androidx.compose.foundation.text.handwriting.a.b);
        int i = iI02 * 2;
        int i2 = iI0 * 2;
        hr1 hr1VarQ = ab1Var.q(xz.j(i, i2, j));
        int i3 = hr1VarQ.e - i2;
        return hb1Var.P(hr1VarQ.d - i, i3, re0.d, new dw0(hr1VarQ, iI02, iI0, 2));
    }
