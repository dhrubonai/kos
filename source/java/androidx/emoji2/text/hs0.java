...
public abstract class hs0 {
    ...
    static {
        ...
        for (int i = 0; i < 61; i++) {
            if (!linkedHashMap.containsKey(cr0VarArr[i].f214a)) {
                linkedHashMap.put(cr0VarArr[i].f214a, Integer.valueOf(i));
            }
        }
        Map unmodifiableMap = Collections.unmodifiableMap(linkedHashMap);
        lx0.w(unmodifiableMap, "unmodifiableMap(result)");
        b = unmodifiableMap;
    }
