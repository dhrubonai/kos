...
public final class i {
        ...
        try {
            ...
            while (entries.hasMoreElements()) {
                ...
                if (name.startsWith(a.a.a.c.a(-857409175306018L, strArr))) {
                    this.f498a.add(a.a.a.c.a(-857417765240610L, strArr));
                } else if (name.startsWith(a.a.a.c.a(-857512254521122L, strArr))) {
                    this.f498a.add(a.a.a.c.a(-857529434390306L, strArr));
                } else if (name.startsWith(a.a.a.c.a(-857563794128674L, strArr))) {
                    this.f498a.add(a.a.a.c.a(-857082757791522L, strArr));
                }
            }
            l8.F(zipFile);
        } catch (Exception e2) {
    ...
    public static boolean a(File file) {
        String[] strArr = xa1.b;
        HashMap hashMap = b;
        i iVar = (i) hashMap.get(file);
        if (iVar == null) {
            iVar = new i(file);
            hashMap.put(file, iVar);
        }
        HashSet hashSet = iVar.f498a;
        if (hashSet.isEmpty()) {
            return true;
        }
        c01 c01Var = c01.r;
