...
public final class i61 implements LineHeightSpan {
    ...
    public i61(float f, int i, boolean z, boolean z2, float f2, boolean z3) {
        this.d = f;
        this.e = i;
        this.f = z;
        this.g = z2;
        ...
        if ((0.0f > f2 || f2 > 1.0f) && f2 != -1.0f) {
            jv0.b("topRatio should be in [0..1] range or -1");
        }
    }
