    ...
    */
    public final void draw(android.graphics.Canvas r19, java.lang.CharSequence r20, int r21, int r22, float r23, int r24, int r25, int r26, android.graphics.Paint r27) {
        ...
        L56:
            ...
            r10.setColor(r1)
        L86:
            androidx.emoji2.text.qd0 r1 = androidx.emoji2.text.qd0.a()
            r1.getClass()
            r1 = r25
            float r1 = (float) r1
            if (r10 == 0) goto L93
        ...
        L93:
            r10 = r2
        L94:
            androidx.emoji2.text.hp2 r2 = r0.e
            androidx.emoji2.text.s6 r3 = r2.b
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.emoji2.text.ip2.draw(android.graphics.Canvas, java.lang.CharSequence, int, int, float, int, int, int, android.graphics.Paint):void");
    }
    ...
    public final int getSize(Paint paint, CharSequence charSequence, int i, int i2, Paint.FontMetricsInt fontMetricsInt) {
        ...
        hp2 hp2Var = this.e;
        this.g = fAbs / (hp2Var.b().a(14) != 0 ? ((ByteBuffer) r8.g).getShort(r1 + r8.d) : (short) 0);
