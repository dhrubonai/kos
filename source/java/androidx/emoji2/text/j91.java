...
public final class j91 extends m91 {
    ...
    public j91(String str, String str2, boolean z) {
        lx0.x(str, a.a.a.c.a(-281363866599202L, wj1.f1284a));
        this.f568a = str;
        this.b = str2;
        this.c = z;
    }
    ...
    public final boolean equals(Object obj) {
        ...
        j91 j91Var = (j91) obj;
        return lx0.n(this.f568a, j91Var.f568a) && lx0.n(this.b, j91Var.b) && this.c == j91Var.c;
    }

    public final int hashCode() {
        int iHashCode = this.f568a.hashCode() * 31;
        String str = this.b;
