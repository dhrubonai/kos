...
public final class jo0 {
    ...
    public jo0(String str, boolean z, boolean z2) {
        a.a.a.c.a(-22244194664226L, wj1.f1284a);
        this.f591a = str;
        this.b = z;
        this.c = z2;
    }
    ...
    public final boolean equals(Object obj) {
        ...
        jo0 jo0Var = (jo0) obj;
        return lx0.n(this.f591a, jo0Var.f591a) && this.b == jo0Var.b && this.c == jo0Var.c;
    }

    public final int hashCode() {
        return Boolean.hashCode(this.c) + jx0.d(this.f591a.hashCode() * 31, 31, this.b);
    }
