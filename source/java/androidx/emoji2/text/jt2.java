...
public final class jt2 {
    ...
    static {
        float[] fArr = xo2.c;
        float fP = (float) ((xo2.P() * 63.66197723675813d) / 100.0d);
        float[][] fArr2 = xo2.f1349a;
        float f = fArr[0];
        float[] fArr3 = fArr2[0];
        float f2 = fArr3[0] * f;
        float f3 = fArr[1];
        ...
        float f10 = 1.0f / ((5.0f * fP) + 1.0f);
        float f11 = f10 * f10 * f10 * f10;
        float f12 = 1.0f - f11;
        float fCbrt = (0.1f * f12 * f12 * ((float) Math.cbrt(fP * 5.0d))) + (f11 * fP);
        float fP2 = xo2.P() / fArr[1];
        double d2 = fP2;
        ...
        k = new jt2(fP2, ((fArr7[2] * 0.05f) + (fArr7[0] * 2.0f) + fArr7[1]) * fPow, fPow, fPow, f9, 1.0f, new float[]{(((100.0f / f6) * fExp) + 1.0f) - fExp, (((100.0f / f7) * fExp) + 1.0f) - fExp, (((100.0f / f8) * fExp) + 1.0f) - fExp}, fCbrt, (float) Math.pow(fCbrt, 0.25d), fSqrt);
    }

    public jt2(float f, float f2, float f3, float f4, float f5, float f6, float[] fArr, float f7, float f8, float f9) {
        this.f = f;
        this.f599a = f2;
        this.b = f3;
        this.c = f4;
