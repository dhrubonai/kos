...
public final class ju {
    ...
    public final boolean equals(Object obj) {
        ...
        ju juVar = (ju) obj;
        return lx0.n(this.f599a, juVar.f599a) && lx0.n(this.b, juVar.b) && lx0.n(this.c, juVar.c) && lx0.n(this.d, juVar.d) && lx0.n(this.e, juVar.e);
    }
    ...
    public final String toString() {
        return "CompletedContinuation(result=" + this.f599a + ", cancelHandler=" + this.b + ", onCancellation=" + this.c + ", idempotentResume=" + this.d + ", cancelCause=" + this.e + ')';
    }
