    ...
    public final Object e(Object obj) {
        ...
        switch (i) {
            case 0:
                ...
                f20 f20Var = h51Var.t;
                if (nk2Var != null) {
                    ak2 i5 = h51Var.d.i(xs.m0(new qi0(), new du(ueVar, 1)));
                    nk2Var.a(null, i5);
                    f20Var.e(i5);
                } else {
                    up2Var = null;
                ...
                if (up2Var == null) {
                    ...
                    int i6 = al2.c;
                    int i7 = (int) (j >> 32);
                    String obj4 = wf2.q0(str, i7, (int) (j & 4294967295L), ueVar).toString();
                    int length = ueVar.e.length() + i7;
                    f20Var.e(new ak2(4, obj4, n6.F(length, length)));
                }
                return Boolean.TRUE;
            case 1:
                u62 u62Var = (u62) obj;
