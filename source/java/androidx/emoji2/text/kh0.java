...
public final class kh0 extends AnimatorListenerAdapter implements qn2 {
    ...
    public final void b() {
        ...
        view.setTag(R.id.transition_pause_alpha, Float.valueOf(view.getVisibility() == 0 ? bt2.f166a.O(view) : 0.0f));
    }

    @Override // androidx.emoji2.text.qn2
    public final void f() {
        this.f639a.setTag(R.id.transition_pause_alpha, null);
    }

    @Override // android.animation.AnimatorListenerAdapter, android.animation.Animator.AnimatorListener
    public final void onAnimationCancel(Animator animator) {
        bt2.f166a.f0(this.f639a, 1.0f);
    }
