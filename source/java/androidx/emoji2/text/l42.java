...
public final class l42 {
    ...
    public final g01 f673a;
    public final g01 b;

    /* JADX WARN: Multi-variable type inference failed */
    public l42(sm0 sm0Var, sm0 sm0Var2) {
        this.f673a = (g01) sm0Var;
        this.b = (g01) sm0Var2;
    }
    ...
    public final String toString() {
        return "ScrollAxisRange(value=" + ((Number) this.f673a.a()).floatValue() + ", maxValue=" + ((Number) this.b.a()).floatValue() + ", reverseScrolling=false)";
    }
}
