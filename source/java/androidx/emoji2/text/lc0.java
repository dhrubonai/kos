...
public abstract class lc0 extends ListView {
    ...
    */
    public final boolean b(android.view.MotionEvent r18, int r19) throws java.lang.IllegalAccessException, java.lang.IllegalArgumentException {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.emoji2.text.lc0.b(android.view.MotionEvent, int):boolean");
    }
        ...
        if (iPointToPosition != -1 && iPointToPosition != getSelectedItemPosition()) {
            ...
            if (childAt.isEnabled()) {
                ...
                if (i < 30 || !hc0.d) {
                    ...
                    try {
                        hc0.f467a.invoke(this, Integer.valueOf(iPointToPosition), childAt, Boolean.FALSE, -1, -1);
                        hc0.b.invoke(this, Integer.valueOf(iPointToPosition));
                        hc0.c.invoke(this, Integer.valueOf(iPointToPosition));
