        ...
        switch (this.d) {
            case 0:
                ...
                if (txVar.P(iIntValue & 1, (iIntValue & 17) != 16)) {
                    gu0 gu0VarW = ly0.w();
                    String strI0 = n6.i0(txVar, R.string.accounts_advanced_title);
                    String strI02 = n6.i0(txVar, R.string.accounts_advanced_summary);
                    long j = vz0.j;
                    a.a.a.c.a(-176691218628386L, strArr);
                    sm0 sm0Var = this.e;
                    boolean zF = txVar.f(sm0Var);
                    Object objM = txVar.M();
                    if (zF || objM == kx.f663a) {
                        objM = new r2(sm0Var, this.f, 0);
                        txVar.i0(objM);
                    }
                    a01.e(gu0VarW, strI0, null, strI02, j, (sm0) objM, null, txVar, 0, 68);
                } else {
                    txVar.S();
                }
                break;
