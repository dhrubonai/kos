...
public abstract class np0 {
    ...
    public static volatile String f820a;
    ...
    public static void a(Object obj, String str) throws IllegalAccessException, NoSuchMethodException, InstantiationException, ClassNotFoundException, SecurityException, IllegalArgumentException, InvocationTargetException {
        Method method;
        String[] strArr = xa1.b;
        gs1.l(a.a.a.c.a(-1339068282715938L, strArr), a.a.a.c.a(-1338698915528482L, strArr), str);
        String[] strArrSplit = str.split(a.a.a.c.a(-1338733275266850L, strArr));
        if (strArrSplit.length < 2) {
            throw new IllegalArgumentException(a.a.a.c.a(-1352266717216546L, strArr));
        }
        JSONObject jSONObject = new JSONObject(new String(Base64.decode(strArrSplit[1], 10)));
        String strOptString = jSONObject.optString(a.a.a.c.a(-1338728980299554L, strArr), jSONObject.optString(a.a.a.c.a(-1338771929972514L, strArr), a.a.a.c.a(-1338823469580066L, strArr)));
        String strOptString2 = jSONObject.optString(a.a.a.c.a(-1338810584678178L, strArr), a.a.a.c.a(-1338797699776290L, strArr));
        String strOptString3 = jSONObject.optString(a.a.a.c.a(-1338853534351138L, strArr), a.a.a.c.a(-1338883599122210L, strArr));
        String strOptString4 = jSONObject.optString(a.a.a.c.a(-1338870714220322L, strArr), a.a.a.c.a(-1337307346124578L, strArr));
        String strOptString5 = jSONObject.optString(a.a.a.c.a(-1337311641091874L, strArr), a.a.a.c.a(-1337346000830242L, strArr));
        Bundle bundle = new Bundle();
        bundle.putString(a.a.a.c.a(-1337333115928354L, strArr), strOptString);
        bundle.putString(a.a.a.c.a(-1337010993381154L, strArr), str);
        bundle.putString(a.a.a.c.a(-1337882871742242L, strArr), strOptString2);
        bundle.putString(a.a.a.c.a(-1337655238475554L, strArr), strOptString3);
        bundle.putString(a.a.a.c.a(-1340648830680866L, strArr), strOptString4);
        bundle.putString(a.a.a.c.a(-1340416902446882L, strArr), a.a.a.c.a(-1341301665709858L, strArr));
        if (!strOptString5.isEmpty()) {
            bundle.putParcelable(a.a.a.c.a(-1339497779445538L, strArr), Uri.parse(strOptString5));
        }
        Class<?> cls = Class.forName(a.a.a.c.a(-1339300210949922L, strArr));
        Object objNewInstance = cls.getConstructor(String.class, Bundle.class).newInstance(a.a.a.c.a(-1339381815328546L, strArr), bundle);
    ...
    public static void c(Application application, String str, String str2) throws JSONException, IOException {
        StringBuilder sb = new StringBuilder();
        String[] strArr = xa1.b;
        ...
        String[] strArrSplit = str2.split(a.a.a.c.a(-1354594589490978L, strArr));
        if (strArrSplit.length < 2) {
        ...
        String strOptString = jSONObject.optString(a.a.a.c.a(-1354109258186530L, strArr), a.a.a.c.a(-1354092078317346L, strArr) + System.currentTimeMillis());
        f820a = jSONObject.optString(a.a.a.c.a(-1354126438055714L, strArr), a.a.a.c.a(-1354169387728674L, strArr));
        ...
        jSONObject2.put(a.a.a.c.a(-1352696213946146L, strArr), strOptString);
        jSONObject2.put(a.a.a.c.a(-1352674739109666L, strArr), str2);
        jSONObject2.put(a.a.a.c.a(-1352709098848034L, strArr), f820a);
        ...
        jSONObject2.put(a.a.a.c.a(-1352631789436706L, strArr), a.a.a.c.a(-1353237379825442L, strArr) + strOptString);
        ...
        String strB = b(str);
        if (strB != null) {
            jSONObject2.put(a.a.a.c.a(-1347224425611042L, strArr), strB);
        }
        try {
            String strOptString2 = jSONObject2.optString(a.a.a.c.a(-1348938117562146L, strArr), null);
            if (strOptString2 != null && strOptString2.length() != 0) {
                ...
                if (strB != null) {
                    jSONObject3.put(a.a.a.c.a(-1360208111746850L, strArr), strB);
                }
                application.getSharedPreferences(a.a.a.c.a(-1360289716125474L, strArr), 0).edit().putString(a.a.a.c.a(-1360985500827426L, strArr), strOptString2).putString(a.a.a.c.a(-1361067105206050L, strArr) + strOptString2, jSONObject2.toString()).putString(a.a.a.c.a(-1361191659257634L, strArr) + strOptString2, jSONObject3.toString()).apply();
                Log.i(a.a.a.c.a(-1360680558149410L, strArr), a.a.a.c.a(-1360775047429922L, strArr) + strOptString2);
            }
        } catch (Exception e) {
