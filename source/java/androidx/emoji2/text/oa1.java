    ...
    public final void d(View view, s1 s1Var) {
        ...
        switch (this.d) {
            case 0:
                ...
                s1Var.f1045a.setCollectionInfo(null);
                break;
            case 1:
                this.f76a.onInitializeAccessibilityNodeInfo(view, s1Var.f1045a);
                NestedScrollView nestedScrollView = (NestedScrollView) view;
    ...
    */
    public boolean g(android.view.View r5, int r6, android.os.Bundle r7) {
        ...
        La1:
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.emoji2.text.oa1.g(android.view.View, int, android.os.Bundle):boolean");
    }
}
