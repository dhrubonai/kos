        ...
        switch (i) {
            ...
            case 1:
                ...
                if (txVar2.P(intValue & 1, (intValue & 3) != 2)) {
                    ...
                    lx0.h((sm0) M2, null, false, null, null, null, fw.f, txVar2, 805306374, 510);
                } else {
                    txVar2.S();
                }
                break;
            default:
                ...
                if (txVar3.P(intValue & 1, (intValue & 3) != 2)) {
                    ...
                    lx0.h((sm0) M3, null, false, null, null, null, ow.g, txVar3, 805306374, 510);
                } else {
                    txVar3.S();
                }
                break;
