    ...
    public final Object e(Object obj) throws IOException {
        ...
        switch (i) {
            case 0:
                ...
                float f = (((int) (j >> 32)) - ((int) (jD >> 32))) / 2.0f;
                float f2 = (((int) (j & 4294967295L)) - ((int) (jD & 4294967295L))) / 2.0f;
                float f3 = (1 - 1.0f) * f;
            ...
            case 1:
                jf0 jf0Var = (jf0) obj;
                qf0 qf0Var = (qf0) obj2;
                mb2 mb2Var = qf0Var.t.f1008a.b;
                long j2 = 0;
                long j3 = mb2Var != null ? ((nw0) mb2Var.f741a.e(new uw0(j))).f830a : 0L;
                mb2 mb2Var2 = qf0Var.u.f1385a.b;
                long j4 = mb2Var2 != null ? ((nw0) mb2Var2.f741a.e(new uw0(j))).f830a : 0L;
                int iOrdinal = jf0Var.ordinal();
                if (iOrdinal == 0) {
                    j2 = j3;
                } else if (iOrdinal != 1) {
                    if (iOrdinal != 2) {
            ...
            case 2:
                f31 f31Var = (f31) obj2;
                long jC = nw0.c(((nw0) ((ed) obj).d()).f830a, j);
                int i2 = f31.t;
                f31Var.g(jC);
                f31Var.c.a();
                return up2Var;
