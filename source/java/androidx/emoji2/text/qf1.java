...
public final class qf1 implements List, sy0 {
    public final Object d;
    public final int e;
    public int f;

    public qf1(List list, int i, int i2) {
        this.d = list;
        this.e = i;
        this.f = i2;
    }
