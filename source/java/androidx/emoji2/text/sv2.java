...
public final class sv2 extends rv2 {
    public static final wv2 s = wv2.d(null, WindowInsets.CONSUMED);
    ...
    public zv0 g(int i) {
        return zv0.c(this.c.getInsets(vv2.a(i)));
    }

    @Override // androidx.emoji2.text.qv2, androidx.emoji2.text.mv2, androidx.emoji2.text.tv2
    public zv0 h(int i) {
        return zv0.c(this.c.getInsetsIgnoringVisibility(vv2.a(i)));
    }

    @Override // androidx.emoji2.text.qv2, androidx.emoji2.text.mv2, androidx.emoji2.text.tv2
    public boolean q(int i) {
        return this.c.isVisible(vv2.a(i));
    }
