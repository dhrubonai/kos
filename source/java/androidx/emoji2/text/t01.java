...
public final class t01 {
    ...
    public final CharSequence f1097a;
    ...
    public final BoringLayout.Metrics a() {
        if (!this.g) {
            TextDirectionHeuristic textDirectionHeuristicA = vk2.a(this.c);
            int i = Build.VERSION.SDK_INT;
            CharSequence charSequence = this.f1097a;
        ...
        if (charSequence == null) {
            ...
            if (charSequence instanceof Spanned) {
                ...
                if (nz0.E(spanned, CharacterStyle.class) && (characterStyleArr = (CharacterStyle[]) spanned.getSpans(0, charSequence.length(), CharacterStyle.class)) != null && characterStyleArr.length != 0) {
                    c0 c0VarE = h50.E(characterStyleArr);
                    SpannableString spannableString = null;
                    while (c0VarE.hasNext()) {
                        CharacterStyle characterStyle = (CharacterStyle) c0VarE.next();
    ...
    */
    public final float c() {
        ...
        L34:
            ...
            goto L5d
        L39:
            java.lang.CharSequence r2 = r6.f1097a
            boolean r4 = r2 instanceof android.text.Spanned
            if (r4 == 0) goto L51
            android.text.Spanned r2 = (android.text.Spanned) r2
            java.lang.Class<androidx.emoji2.text.k51> r4 = androidx.emoji2.text.k51.class
            boolean r4 = androidx.emoji2.text.nz0.E(r2, r4)
            if (r4 != 0) goto L5a
            java.lang.Class<androidx.emoji2.text.j51> r4 = androidx.emoji2.text.j51.class
            boolean r2 = androidx.emoji2.text.nz0.E(r2, r4)
            if (r2 != 0) goto L5a
        L51:
        ...
        L5d:
            ...
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.emoji2.text.t01.c():float");
    }
}
