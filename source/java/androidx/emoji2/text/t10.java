...
public final class t10 extends ViewGroup.MarginLayoutParams {
        ...
        if (zHasValue) {
            ...
            if (TextUtils.isEmpty(string)) {
                ...
                try {
                    ...
                    q10Var = (q10) constructor.newInstance(context, attributeSet);
                } catch (Exception e) {
    ...
    public t10(t10 t10Var) {
        super((ViewGroup.MarginLayoutParams) t10Var);
        this.b = false;
        this.c = 0;
        this.d = 0;
        this.e = -1;
    ...
    public t10(ViewGroup.MarginLayoutParams marginLayoutParams) {
