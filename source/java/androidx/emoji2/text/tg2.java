...
public final class tg2 {
    ...
    public final boolean equals(Object obj) {
        ...
        tg2 tg2Var = (tg2) obj;
        return lx0.n(this.f1119a, tg2Var.f1119a) && lx0.n(this.b, tg2Var.b) && lx0.n(this.c, tg2Var.c) && this.d == tg2Var.d;
    }

    public final int hashCode() {
        return Boolean.hashCode(this.d) + ((this.c.hashCode() + ((this.b.hashCode() + (this.f1119a.hashCode() * 31)) * 31)) * 31);
    }
