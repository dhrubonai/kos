...
public final class ts {
    ...
    public final void b() {
        ...
        float f4 = this.X;
        if (f3 != f4) {
            textPaint.setLetterSpacing(h(f4, f3, f, oh0Var));
        } else {
    ...
    public final StaticLayout e(int i, TextPaint textPaint, CharSequence charSequence, float f, boolean z) {
        ...
        hf2 hf2Var = new hf2(charSequence, textPaint, (int) f);
        hf2Var.l = this.A;
        hf2Var.k = z;
        hf2Var.e = alignment;
        hf2Var.j = false;
    ...
    public final void i(Configuration configuration) {
        if (Build.VERSION.SDK_INT >= 31) {
            ...
            if (typeface != null) {
                this.t = az0.V(configuration, typeface);
            }
            Typeface typeface2 = this.x;
            if (typeface2 != null) {
                this.w = az0.V(configuration, typeface2);
            }
