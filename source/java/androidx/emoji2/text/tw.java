        ...
        switch (this.d) {
            ...
            default:
                ...
                if (iIndexOf >= 0) {
                    ...
                    if (vf0Var.get(iIndexOf) != tgVar) {
                        tg tgVar2 = (tg) vf0Var.get(iIndexOf);
                        ...
                        h82Var.f460a.edit().putString(a.a.a.c.a(-330579896844066L, strArr2), str4).commit();
                        if (Build.VERSION.SDK_INT >= 33 && (localeManagerB = m1.b(applicationContext.getSystemService(m1.q()))) != null) {
                            localeManagerB.setApplicationLocales(tgVar2 == tg.g ? LocaleList.getEmptyLocaleList() : LocaleList.forLanguageTags(str4));
                        }
