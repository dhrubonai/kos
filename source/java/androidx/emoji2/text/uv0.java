...
public final class uv0 {
    ...
    public AutofillId b(long j) {
        ...
        ContentCaptureSession contentCaptureSessionI = v6.i(this.f1194a);
        r1 r1VarA = jz0.A(this.b);
        Objects.requireNonNull(r1VarA);
        return f00.b(contentCaptureSessionI, ej.g(r1VarA.f990a), j);
    }

    public uv0(ContentCaptureSession contentCaptureSession, View view) {
        this.f1194a = contentCaptureSession;
        this.b = view;
    }
}
