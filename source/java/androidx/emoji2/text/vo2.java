...
public final class vo2 implements uc0 {
    ...
    public vo2(int i, yc0 yc0Var, int i2) {
        this((i2 & 1) != 0 ? 300 : i, 0, (i2 & 4) != 0 ? zc0.f1429a : yc0Var);
    }

    @Override // androidx.emoji2.text.he
    public final yq2 a(wo2 wo2Var) {
        return new kz(this.f1233a, this.b, this.c);
    }

    public final boolean equals(Object obj) {
        if (obj instanceof vo2) {
            vo2 vo2Var = (vo2) obj;
            if (vo2Var.f1233a == this.f1233a && vo2Var.b == this.b && lx0.n(vo2Var.c, this.c)) {
                return true;
            }
        }
        return false;
    ...
    public final int hashCode() {
        return ((this.c.hashCode() + (this.f1233a * 31)) * 31) + this.b;
    }
