...
public final class xj1 extends lr1 {
    ...
    static {
        boolean z = false;
        try {
            Class.forName("org.openjsse.net.ssl.OpenJSSE", false, wj1.class.getClassLoader());
            z = true;
    ...
    public final SSLContext k() {
        ...
        lx0.w(sSLContext, "getInstance(\"TLSv1.3\", provider)");
        return sSLContext;
    }
