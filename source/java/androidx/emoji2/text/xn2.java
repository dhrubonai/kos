...
public abstract class xn2 {
    ...
    public static final /* synthetic */ int f1346a = 0;
    ...
    public static final mn2 a(tn2 tn2Var, wo2 wo2Var, String str, lx lxVar, int i, int i2) {
        ...
        boolean f = ((tx) lxVar).f(tn2Var);
        tx txVar = (tx) lxVar;
        Object M = txVar.M();
        on onVar = kx.f662a;
        if (f || M == onVar) {
            M = new mn2(tn2Var, wo2Var, str);
            txVar.i0(M);
        }
        mn2 mn2Var = (mn2) M;
        boolean f2 = txVar.f(tn2Var) | txVar.h(mn2Var);
        Object M2 = txVar.M();
        if (f2 || M2 == onVar) {
            M2 = new v32(8, tn2Var, mn2Var);
            txVar.i0(M2);
        }
        bz0.k(mn2Var, (um0) M2, txVar);
    ...
    public static final pn2 b(tn2 tn2Var, Float f, Float f2, ri0 ri0Var, lx lxVar) {
        ...
        if (f3 || M == onVar) {
            ...
            keVar.d();
            M = new pn2(tn2Var, f, keVar, wo2Var);
            txVar.i0(M);
        }
        pn2 pn2Var = (pn2) M;
        if (tn2Var.g()) {
        ...
        boolean f4 = txVar.f(tn2Var) | txVar.f(pn2Var);
        Object M2 = txVar.M();
        if (f4 || M2 == onVar) {
            M2 = new v32(9, tn2Var, pn2Var);
            txVar.i0(M2);
        }
        bz0.k(pn2Var, (um0) M2, txVar);
        return pn2Var;
    }
    ...
    public static final tn2 c(Object obj, String str, lx lxVar, int i, int i2) {
        ...
        on onVar = kx.f662a;
        if (M == onVar) {
            M = new tn2(new of1(obj), null, str);
            txVar.i0(M);
        }
        tn2 tn2Var = (tn2) M;
