...
public final class yu2 implements ValueAnimator.AnimatorUpdateListener {
    ...
    public final /* synthetic */ fv2 f1403a;
    ...
    public final void onAnimationUpdate(ValueAnimator valueAnimator) {
        ...
        for (int i2 = 1; i2 <= 512; i2 <<= 1) {
            if ((this.d & i2) == 0) {
                ...
                zv0 zv0VarG = tv2Var.g(i2);
                zv0 zv0VarG2 = this.c.f1306a.g(i2);
                float f = 1.0f - fC;
                kv2Var.c(i2, wv2.b(zv0VarG, (int) (((zv0VarG.f1457a - zv0VarG2.f1457a) * f) + 0.5d), (int) (((zv0VarG.b - zv0VarG2.b) * f) + 0.5d), (int) (((zv0VarG.c - zv0VarG2.c) * f) + 0.5d), (int) (((zv0VarG.d - zv0VarG2.d) * f) + 0.5d)));
            }
        }
