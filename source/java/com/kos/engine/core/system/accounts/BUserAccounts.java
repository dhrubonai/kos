...
public class BUserAccounts implements Parcelable {
    public static final Parcelable.Creator<BUserAccounts> CREATOR = new Parcelable.Creator<BUserAccounts>() { // from class: com.kos.engine.core.system.accounts.BUserAccounts.1
    ...
    public Account[] toAccounts() {
        ArrayList arrayList = new ArrayList();
        Iterator<BAccount> it = this.accounts.iterator();
        while (it.hasNext()) {
