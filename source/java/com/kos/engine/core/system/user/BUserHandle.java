...
public final class BUserHandle implements Parcelable {
    ...
    public static final Parcelable.Creator<BUserHandle> CREATOR = new Parcelable.Creator<BUserHandle>() { // from class: com.kos.engine.core.system.user.BUserHandle.1
    ...
    public static int parseUserArg(String str) {
        String[] strArr = xa1.b;
        if (c.a(-372017741315874L, strArr).equals(str)) {
            return -1;
        }
        if (c.a(-372069280923426L, strArr).equals(str) || c.a(-372103640661794L, strArr).equals(str)) {
            return -2;
        }
        try {
            return Integer.parseInt(str);
        } catch (NumberFormatException unused) {
            throw new IllegalArgumentException(zd.k(new StringBuilder(), c.a(-372086460792610L, strArr), str));
        }
    }
    ...
    public String toString() {
        ...
        String[] strArr = xa1.b;
        sb.append(c.a(-371665553997602L, strArr));
        sb.append(this.mHandle);
        sb.append(c.a(-371682733866786L, strArr));
        return sb.toString();
    }
