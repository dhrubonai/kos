    ...
    public static class Get extends MethodHook {
        ...
        public Object hook(Object obj, Method method, Object[] objArr) throws IllegalAccessException, IllegalArgumentException, InvocationTargetException {
            ...
            try {
                ...
                if (objInvoke != null && !c.a(-320405119319842L, strArr).equals(objInvoke.toString()) && !c.a(-320465248861986L, strArr).equals(objInvoke.toString())) {
                    return objInvoke;
                }
    ...
    public static class GetAndroidId extends MethodHook {
        ...
        public Object hook(Object obj, Method method, Object[] objArr) throws IllegalAccessException, IllegalArgumentException, InvocationTargetException {
            ...
            try {
                ...
                Object objInvoke = method.invoke(obj, objArr);
                if (objInvoke != null && !c.a(-320701472063266L, strArr).equals(objInvoke.toString()) && !c.a(-320692882128674L, strArr).equals(objInvoke.toString())) {
                    return objInvoke;
                }
    ...
    public static class GetLong extends MethodHook {
        ...
        public Object hook(Object obj, Method method, Object[] objArr) throws IllegalAccessException, IllegalArgumentException, InvocationTargetException {
            ...
            try {
                ...
                if (objInvoke != null && ((Number) objInvoke).longValue() != 0) {
                    return objInvoke;
                }
    ...
    public static class GetString extends MethodHook {
        ...
        public Object hook(Object obj, Method method, Object[] objArr) throws IllegalAccessException, IllegalArgumentException, InvocationTargetException {
            ...
            try {
                ...
                if (objInvoke != null && !c.a(-331984351149858L, strArr).equals(objInvoke.toString()) && !c.a(-332044480692002L, strArr).equals(objInvoke.toString())) {
                    return objInvoke;
                }
    ...
    public static class Read extends MethodHook {
        ...
        public Object hook(Object obj, Method method, Object[] objArr) throws IllegalAccessException, IllegalArgumentException, InvocationTargetException {
            ...
            try {
                ...
                if (objInvoke != null && !c.a(-330781760306978L, strArr).equals(objInvoke.toString()) && !c.a(-330841889849122L, strArr).equals(objInvoke.toString())) {
                    return objInvoke;
                }
