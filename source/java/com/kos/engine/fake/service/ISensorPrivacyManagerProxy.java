...
public class ISensorPrivacyManagerProxy extends BinderInvocationStub {
    ...
    public Object getWho() throws IllegalAccessException, IllegalArgumentException, InvocationTargetException {
        ...
        try {
            try {
                fy1 fy1VarG = fy1.g(c.a(-1120866764209954L, strArr));
                objInvoke = fy1VarG.a(fy1VarG.b, c.a(-1120471627218722L, strArr), BRServiceManager.get().getService(c.a(-1120557526564642L, strArr)));
            } catch (Exception e) {
                nz0.Q(c.a(-1120639130943266L, strArr), 3, c.a(-1121236131397410L, strArr) + e.getMessage());
                try {
                    fy1 fy1VarG2 = fy1.g(c.a(-1121450879762210L, strArr));
                    objInvoke = fy1VarG2.a(fy1VarG2.b, c.a(-1121085807542050L, strArr), BRServiceManager.get().getService(c.a(-1121102987411234L, strArr)));
                } catch (Exception e2) {
                    nz0.Q(c.a(-1121167411920674L, strArr), 3, c.a(-1119582568988450L, strArr) + e2.getMessage());
                    try {
                        objInvoke = Class.forName(c.a(-1119745777745698L, strArr)).getMethod(c.a(-1119350640754466L, strArr), IBinder.class).invoke(null, BRServiceManager.get().getService(c.a(-1119436540100386L, strArr)));
                    } catch (Exception e3) {
