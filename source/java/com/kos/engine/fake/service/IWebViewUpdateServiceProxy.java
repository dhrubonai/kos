...
public class IWebViewUpdateServiceProxy extends BinderInvocationStub {
    ...
    public static class GetValidWebViewPackages extends MethodHook {
        ...
        public Object hook(Object obj, Method method, Object[] objArr) throws IllegalAccessException, IllegalArgumentException, InvocationTargetException {
            ...
            try {
                Object objInvoke = method.invoke(obj, objArr);
                if (objInvoke != null && objInvoke.getClass().isArray() && (length = Array.getLength(objInvoke)) > 0) {
    ...
    public static class IgnoreMultiProcessToggle extends MethodHook {
        ...
        public Object hook(Object obj, Method method, Object[] objArr) {
            ...
            String[] strArr = xa1.b;
            String strA = c.a(-1044029799284514L, strArr);
            StringBuilder sb = new StringBuilder();
            zd.t(sb, c.a(-1044128583532322L, strArr), method);
            zd.p(sb, c.a(-1042616755044130L, strArr), 5, strA);
            return null;
        }
    }
    ...
    public static class IsMultiProcessEnabled extends MethodHook {
        ...
        public Object hook(Object obj, Method method, Object[] objArr) {
            ...
            try {
                Object objInvoke = method.invoke(obj, objArr);
                nz0.Q(c.a(-1043385554190114L, strArr), 3, c.a(-1042934582624034L, strArr) + objInvoke);
                return objInvoke;
            } catch (Throwable th) {
        ...
        public Object hook(Object obj, Method method, Object[] objArr) {
            ...
            if (objArr != null && objArr.length > 0) {
                ...
                if (isKnownWebViewPackage(str)) {
                    String strA = c.a(-1046654024302370L, strArr);
                    StringBuilder sb = new StringBuilder();
                    sb.append(c.a(-1046185872867106L, strArr));
                    sb.append(str);
                    zd.p(sb, c.a(-1046301836984098L, strArr), 3, strA);
                    return Boolean.TRUE;
                }
            }
            try {
    ...
    public Object getWho() {
        ...
        try {
            ...
            return Class.forName(c.a(-1039584508133154L, strArr)).getMethod(c.a(-1039197961076514L, strArr), IBinder.class).invoke(null, iBinderFindServiceBinder);
        } catch (Throwable th) {
